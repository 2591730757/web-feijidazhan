...
var initGame={
	...
	GameOver(){
		...
		// if(num2<this.score){
		// 	var num=this.score;
		// 	this.setcookie(number,num,7);
		// }
		// this.getcookie(number);
		// var num2=this.getcookie(number);
		// this.score=num2
		this.setcookie("a",this.score,7)
		num2=this.getcookie("a");
		console.log("num2=",num2);
		var num3=this.document.parseInt(num2);
